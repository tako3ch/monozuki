...
(function(blocks, editor, i18n, element) {
    ...
    // amz
    blocks.registerBlockType("hks-orgblock/amzbox-block", {
        title: __("Amazon", "simple-amzbox"),
        icon: "smiley",
        category: "hks_orgblock",
        attributes: {
            content: {
...
(function(blocks, editor, i18n, element, components, _) {
    ...
    blocks.registerBlockType("hks-orgblock/sectioncard-block", {
        title: i18n.__("見出しが乗るカード", "midashi-card"),
        icon: "index-card",
        category: "hks_orgblock",
        attributes: {
            mediaID: {
        ...
        edit: function(props) {
            ...
            return el(
                ...
                el(RichText, {
                    tagName: "p",
                    inline: true,
                    placeholder: i18n.__("見出しタイトル", "sectioncard-block"),
